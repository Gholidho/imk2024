    ...
    <main class="main">
          ...
          <div class="card shadow mb-4" style="justify-content: center; align-items :center">
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="tableBku table-bordered" id="dataTable" width="90%" cellspacing="0">
                  <thead>
                    <tr>
      ...
      <script>
        $(document).ready(function() {
          $('#dataTable').DataTable({
            searching: true, // Mengaktifkan kotak pencarian
            scrollX: true,
            paging: true,
            scrollCollapse: true,
            scrollY: '570px',
            columns: [
              null, // Kolom NO. (index 0)
              null, // Kolom JABATAN (index 1)
              null, // Kolom NAMA (index 2)
              null // Kolom NOMOR TELEPON (index 3)
            ]
          });
        });
      </script>
