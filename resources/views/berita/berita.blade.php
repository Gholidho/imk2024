                                        ...
                                        <nav style="margin-top: 10px">
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                ...
                                                <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="nav-berita-daerah" aria-selected="false">Daerah</button>
                                                ...
                                                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                                    data-bs-target="#nav-dokumen-perencanaan" type="button" role="tab"
                                                    aria-controls="nav-dokumen-perencanaan"
                                                    aria-selected="false">Perencanaan</button>
                                                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                                    data-bs-target="#nav-info-penting" type="button" role="tab"
                                                    aria-controls="nav-info-penting" aria-selected="false">Penting</button>
                                                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
